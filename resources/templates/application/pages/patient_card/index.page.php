            ...
            <div id="patient-card-menu">
                <div class="row">
                    <div id="buttons" class="col-6 right-border">
                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addPatientCardModal"><i class="fa fa-plus-circle"></i> Создать</button>
                        <button class="btn btn-info btn-sm" onclick="editPatientCardData();"><i class="fa fa-edit"></i> Изменить</button>
                        <button class="btn btn-success btn-sm" hidden><i class="fa fa-save"></i> Сохранить</button>
                        <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Удалить</button>
                    </div>
